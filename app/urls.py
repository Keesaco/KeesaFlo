...
urlpatterns = patterns('',
    ...
    url(r'^app/gating/rectangular/(?P<params>[\.,0-9]+)$', 'views.rect_gating', name='gating_rectangular'),
    url(r'^app/gating/polygon/(?P<params>[\.,0-9]+)$', 'views.poly_gating', name='gating_rectangular'),
    url(r'^app/gating/oval/(?P<params>[\.,0-9]+)$', 'views.oval_gating', name='gating_rectangular'),
